...
<br>
我们原创的分布式身份管理机制，每个AI系统是独立私有化部署的身份自管理节点，拥有多用户隔离的数据空间，只有用户自主掌控的私钥才可解锁；同时在官方根节点上可检索到身份加密副本以自证。在用户、AI节点和根节点三方协作下，既保障了隐私安全又确保身份真实及跨节点漫游互认，以此构建和而不同的开源社区生态。规则说明>> <br>
'''
