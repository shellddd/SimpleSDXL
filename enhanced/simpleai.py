...
identity_note = '当前为游客，请用昵称+手机号组成可信数字身份来绑定本机节点。若已有身份二维码，可用其快速安全地导入身份。节点首个绑定身份将拥有超级管理权限。'
identity_note_1 = '您的身份已绑定当前浏览器和本机节点。若要更换其他身份，需先"解除绑定"。导出身份二维码可适用离线和漫游场景，导出后请妥善保存。'
